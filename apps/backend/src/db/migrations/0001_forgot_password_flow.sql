...
--> statement-breakpoint
CREATE INDEX "password_reset_sessions_user_id_idx" ON "password_reset_sessions" USING btree ("user_id");
--> statement-breakpoint
CREATE INDEX "password_reset_sessions_expires_at_idx" ON "password_reset_sessions" USING btree ("expires_at");